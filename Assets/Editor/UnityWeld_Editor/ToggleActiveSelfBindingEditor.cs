...
{
    // Copy-pasted from UnityWeld_Editor.ToggleActiveBindingEditor and adapted for ToggleActiveSelfBinding
    [CustomEditor(typeof(ToggleActiveSelfBinding))]
    public class ToggleActiveSelfBindingEditor : BaseBindingEditor
    {
        private ToggleActiveSelfBinding targetScript;
        ...
        {
            targetScript = (ToggleActiveSelfBinding)target;
